...
const SEMANTIC_COLORS: Array<{ words: string[]; color: TagColor }> = [
  { words: ["健康", "運動", "筋トレ", "散歩", "ジム", "植物", "園芸"], color: TAG_COLORS[1] },
  { words: ["買物", "買い物", "買う", "食事", "料理", "ごはん", "食品"], color: TAG_COLORS[2] },
  { words: ["仕事", "業務", "会社", "開発", "作業"], color: TAG_COLORS[0] },
  { words: ["勉強", "学習", "読書", "資格", "学校"], color: TAG_COLORS[3] },
  { words: ["趣味", "裁縫", "手芸", "美容", "服"], color: TAG_COLORS[4] },
  { words: ["旅行", "外出", "おでかけ", "掃除", "洗濯", "家事"], color: TAG_COLORS[5] },
  { words: ["お金", "家計", "支払", "銀行", "税"], color: TAG_COLORS[6] },
  { words: ["病院", "通院", "薬", "重要", "急ぎ"], color: TAG_COLORS[7] },
];
...
export function getTagColor(tag: string): TagColor {
  const normalizedTag = tag.normalize("NFKC").toLocaleLowerCase("ja");
